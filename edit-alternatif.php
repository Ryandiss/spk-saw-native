...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-users"></i> Data Peserta Duta Kampus</h1>
	...
	<form action="edit-alternatif.php?id=<?php echo $id_alternatif; ?>" method="post">
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-edit"></i> Edit Data Peserta Duta Kampus</h6>
			</div>
			<?php
			if (!$id_alternatif) {
			?>
						...
						<div class="card-body">
							<div class="row">
								<div class="form-group col-md-12">
									...
									<label class="font-weight-bold">Nama Peserta Duta Kampus</label>
